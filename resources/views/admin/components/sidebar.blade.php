...
<div class="min-h-screen z-50 bg-white overflow-hidden transition-all duration-300 w-64 md:w-fit md:hover:w-64 group">
    ...
    <div class="flex flex-row items-center gap-2 justify-center px-4 h-20 transition-all duration-500">
        ...
        <div class="flex flex-col mt-2 md:hidden">
            ...
            <p class="text-gray-500 text-xs w-fit whitespace-nowrap overflow-hidden">Sistem Informasi Manajemen<br>
                Bengkel dan Administrasi</p>
        </div>
        <div class="hidden md:group-hover:flex md:group-hover:flex-col mt-2">
            <p
                class="text-red-500 font-semibold hidden md:group-hover:inline w-fit whitespace-nowrap overflow-hidden animate-typing">
                SIMBA</p>
            <p class="text-gray-500 text-xs w-fit whitespace-nowrap overflow-hidden animate-typing">Sistem Informasi
                Manajemen<br> Bengkel dan Administrasi</p>
        </div>
    </div>
    ...
    <nav class="flex flex-col items-start justify-center transition-all duration-300 space-y-1 mt-2 px-4">
        ...
        <!-- Logout -->
        <button
            class="btn-logout flex items-center justify-start px-2 py-2 text-red-500 font-medium hover:text-red-600 transition-all duration-200">
