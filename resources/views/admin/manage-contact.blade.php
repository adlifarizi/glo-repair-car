...
@section('content')
    <div class="min-h-screen">
        ...
        <div class="p-4">
            <!-- Dialog -->
            @include('admin.components.dialog', ['id' => 'dialog-success-edit', 'show' => false, 'type' => 'success', 'message' => 'Data kontak berhasil diubah!'])
            @include('admin.components.dialog', ['id' => 'dialog-error-edit', 'show' => false, 'type' => 'error', 'message' => 'Data kontak gagal diubah!'])
            ...
            <div class="p-4 bg-white rounded-xl">
                ...
                <form method="POST" class="w-full mt-6" action="">
                    @csrf
                        ...
                        <div class="grid md:grid-cols-[130px_1fr] grid-cols-1 md:items-center mb-4 gap-2 md:gap-4">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" name="nomor_telepon" id="nomor_telepon"
                                    value="{{ old('nomor_telepon', $contact->nomor_telepon ?? '') }}" placeholder="8xxx"
                        ...
                        <div class="grid md:grid-cols-[auto_1fr] grid-cols-1 md:items-center mb-4 gap-2 md:gap-4">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" name="nomor_whatsapp" id="nomor_whatsapp"
                                    value="{{ old('nomor_whatsapp', $contact->nomor_whatsapp ?? '') }}" placeholder="8xxx"
                                    class="w-full border border-gray-300 rounded-r-md px-4 py-2 focus:ring-gray-500 focus:ring-1 ring-inset focus:outline-none">
                            </div>
                        </div>
                    </div>
