...
@section('content')
    <div>
        ...
        <div class="p-4 bg-white rounded-xl">
            ...
            <p class="text-gray-600">Data ini merupakan data servis mobil yang akan berlangsung hingga sudah selesai
                diperbaiki</p>
            ...
            <table id="data-table" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-lg font-medium text-gray-800 whitespace-nowrap">Nama Pelanggan
                        </th>
                        <th class="px-6 py-3 text-left text-lg font-medium text-gray-800 whitespace-nowrap">Nomor Whatsapp
                        </th>
                        <th class="px-6 py-3 text-left text-lg font-medium text-gray-800 whitespace-nowrap">Status Servis
                        </th>
                        ...
                        <th class="px-6 py-3 text-left text-lg font-medium text-gray-800 whitespace-nowrap">Kunjungan
                            Selanjutnya
                        </th>
                    </tr>
                </thead>
